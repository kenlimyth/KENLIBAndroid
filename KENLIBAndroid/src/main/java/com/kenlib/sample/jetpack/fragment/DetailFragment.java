...
import com.kenlib.android.databinding.FragmentTest1Binding;
...
public class DetailFragment extends Fragment {
    FragmentTest1Binding binding;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentTest1Binding.inflate(LayoutInflater.from(getActivity()));
