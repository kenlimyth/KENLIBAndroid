...
public class ExplosionField extends View{
    ...
    public void explode(final View view) {
        ...
        //震动动画
        ValueAnimator animator = ValueAnimator.ofFloat(0f, 1f).setDuration(50);
...
//        });
    ...
    private void explode(final View view,Rect rect) {
        final ExplosionAnimator animator = new ExplosionAnimator(this, ImgUtil.createBitmapFromView(view), rect,mParticleFactory);
        ...
        animator.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationStart(Animator animation) {
                //缩小,透明动画
                view.animate().setDuration(10).scaleX(0f).scaleY(0f).alpha(0f).start();
            }

            @Override
            public void onAnimationEnd(Animator animation) {

                view.animate().alpha(1f).scaleX(1f).scaleY(1f).setDuration(50).start();
                //动画结束时从动画集中移除
