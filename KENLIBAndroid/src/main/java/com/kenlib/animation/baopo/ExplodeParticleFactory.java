...
public class ExplodeParticleFactory extends ParticleFactory{
    ...
    public static final float X = Util.dp2Px(5);
    public static final float Y = Util.dp2Px(20);
    public static final float V = Util.dp2Px(2);
    public static final float W = Util.dp2Px(1);
