 ...
 *
 */
public class ImageViewYuan extends AppCompatImageView {
	...
	public ImageViewYuan(Context context) {
		super(context);

		init();
	}

	public ImageViewYuan(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public ImageViewYuan(Context context, AttributeSet attrs, int defStyle) {
