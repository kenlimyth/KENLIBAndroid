...
public class XXK extends LinearLayout {
    ...
    public XXK(Context context, AttributeSet attrs) {
        super(context, attrs);

        this.context = (FragmentActivity) context;
        View view = View.inflate(context, R.layout.tab_viewpage, this);
    ...
    private void initTab() {
        ...
        if (!ido.setTabs(mTabTl)) {
            ...
            mTabTl.getTabAt(0).setCustomView(R.layout.tab_item);
            mTabTl.getTabAt(1).setCustomView(R.layout.tab_item1);
            mTabTl.getTabAt(2).setCustomView(R.layout.tab_item2);
            mTabTl.getTabAt(3).setCustomView(R.layout.tab_item3);
