...
import com.yzq.zxinglibrary.util.StatusBarUtils;
...
public class CaptureActivity extends AppCompatActivity implements SurfaceHolder.Callback, View.OnClickListener {
    ...
    //protected EditText etInputCode;
    ...
    protected ImageView unknowIv;
    protected LinearLayoutCompat alWrite;
    ...
    private void initView() {
        ...
        headerLayout = findViewById(R.id.cl_title);
        ...
        unknowIv = findViewById(R.id.unknowIv);
        alWrite = findViewById(R.id.alWrite);
...
//        switchVisibility(albumLayout, config.isShowAlbum());
    ...
    public void switchFlashImg(int flashState) {
        ...
        if (flashState == Constant.FLASH_OPEN) {
            flashLightIv.setImageResource(R.drawable.ic_scan_code_light);
    ...
    protected void onResume() {
        ...
        StatusBarUtils.setStatusFont(this,false);
        StatusBarUtils.with(this).setTitleBarHeight(headerLayout, 48);
