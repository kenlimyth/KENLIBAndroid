 ...
 */
public final class ScanCodeConnectionHandler extends Handler {

    private static final String TAG = ScanCodeConnectionHandler.class
            .getSimpleName();
    ...
    public ScanCodeConnectionHandler(CaptureActivity activity, CameraManager cameraManager) {
