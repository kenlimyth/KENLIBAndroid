...
public class StatusBarUtils {
    ...
    /**
     * 沉浸式状态栏，重新设置titlebar高度
     * @param view
     * @param dpValue titlebar高度
     */
    public void setTitleBarHeight(View view, float dpValue){
        init();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            int statusBarHeight = StatusBarUtils.getStatusBarHeight(mActivity);
            ViewGroup.LayoutParams titleBarLayoutLp =  view.getLayoutParams();
            titleBarLayoutLp.height = DimensUtils.dp2px(mActivity,dpValue) + statusBarHeight;
            view.setLayoutParams(titleBarLayoutLp);
        }
    }
...
//                attributes.flags |= flagTranslucentStatus;
     ...
     * 修改状态栏字体颜色
     */
    public static void setStatusFont(Activity context, boolean dark) {
